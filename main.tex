...
\begin{abstract}
	...
	\vspace{4mm}
	Link Repository: \url{https://github.com/TryKatChup/SistemiOperativi_QA}
...
\end{problem}
\begin{solution}
L’organizzazione monolitica (adottata da GNU/Linux) ha la struttura interna semplice, ingloba in un unico modulo contenente tutte le procedure, ognuna realizzante una funzione specifica.
\newline
...
\begin{itemize}
    \item difficile da manutenere;
    \item meno portabile;
    \item meno efficiente; %davvero meno efficiente? "...quando l'implementazione è completa e sicura, la stretta integrazione interna dei componenti rende un buon kernel monolitico estremamente efficiente..° https://it.wikipedia.org/wiki/Kernel#:~:text=Tuttavia%20i%20kernel%20monolitici%20pi%C3%B9,debbano%20far%20parte%20del%20nuovo
...
\begin{itemize}
    ...
    \item \emph{User structure}: contiene le informazioni necessarie solo quando il processo è residente, come registri CPU, informazioni sulle risorse allocate ecc. (swappable, kernel);
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \newline Si ha così il problema della frammentazione interna: all'interno delle partizioni si vengono a creare spazi inutilizzati.
        \newline
        ...
        \newline È tuttavia presente il problema della frammentazione esterna, causata dalla frammentazione della memoria libera.
    \end{itemize}
\end{itemize}
...
In questo caso occorre memorizzare la cronologia dei caricamenti in memoria, o gestire una coda in cui ogni elemento rappresenta una pagina caricata in memoria.
    ...
    \begin{itemize}
      ...
      \item \emph{Stack}: una struttura dati di tipo stack in cui ogni elemento rappresenta una pagina, ad ogni ogni accesso ad una pagina l'elemento corrispondente si sposta nel top dello stack, mentre il bottom rappresenta la pagina LRU.
      \end{itemize}
\newline
